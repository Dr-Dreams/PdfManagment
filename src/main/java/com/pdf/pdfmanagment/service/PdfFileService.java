...
public class PdfFileService {
     ...
     */
    public List<PdfFile> searchPdfFilesByUserAndFileName(User user, String searchKeyword) {
        return pdfFileRepository.findByUserAndFileNameContainingIgnoreCase(user, searchKeyword);
    }

...
import com.pdf.pdfmanagment.utility.Utility;
...
public class EmailsController {
    ...
    public EmailsController(JavaMailSender mailSender, UserService userService, UserRepository userRepository, PdfFileRepository pdfFileRepository, PdfFileService pdfFileService, CommentService commentService, CommentRepository commentRepository, HttpServletRequest request) {
    ...
    public void sendShareEmail(String recipientEmail, String link)
        ...
        helper.setFrom("pdf_managment@lol.com", "PDF Sharing");
        ...
        String content = "<!DOCTYPE html>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t<tr>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td class=\"pad\">\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"alignment\" align=\"center\" style=\"line-height:10px\"><img src=\"https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/PDF_file_icon.svg/1200px-PDF_file_icon.svg.png\" style=\"display: block; height: auto; border: 0; width: 260px; max-width: 100%;\" width=\"260\" alt=\"Forgot your password?\" title=\"Forgot your password?\"></div>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t</table>\n" +
...
//            return "redirect:/login"; // Replace with the appropriate URL
    ...
    public void sendEmail(String recipientEmail, String link)
        ...
        String content = "<!DOCTYPE html>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t<tr>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td class=\"pad\">\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"alignment\" align=\"center\" style=\"line-height:10px\"><img class=\"big\" src=\"https://img.freepik.com/free-vector/forgot-password-concept-illustration_114360-1123.jpg\" style=\"display: block; height: auto; border: 0; width: 358px; max-width: 100%;\" width=\"358\" alt=\"Forgot your password?\" title=\"Forgot your password?\"></div>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t</table>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t<table class=\"heading_block block-3\" width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" role=\"presentation\" style=\"mso-table-lspace: 0pt; mso-table-rspace: 0pt;\">\n" +
